...
int talk()
{
			...
			printf("│               地图文件以.dat格式储存在主目录下   │\n",0);
		   	printf("│               的map文件夹中，编写格式由开发者    │\n",0);
		   	printf("│               确定。                             │\n",0);
		   	printf("│               用户可通过地图编辑器选项进入编辑器 │\n",0);
			printf("│               说明如下：                         │\n",0);
...
int save_shape(char*name,char*maker)
{
	int i=0;
	printf("┌─────────────────────────┐\n",0);
	printf("│                                                  │\n",0);
